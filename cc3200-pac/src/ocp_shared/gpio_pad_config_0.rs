#[doc = "Register `GPIO_PAD_CONFIG_0` reader"]
pub struct R(crate::R<GPIO_PAD_CONFIG_0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPIO_PAD_CONFIG_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<GPIO_PAD_CONFIG_0_SPEC>> for R {
    fn from(reader: crate::R<GPIO_PAD_CONFIG_0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `GPIO_PAD_CONFIG_0` writer"]
pub struct W(crate::W<GPIO_PAD_CONFIG_0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GPIO_PAD_CONFIG_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<GPIO_PAD_CONFIG_0_SPEC>> for W {
    fn from(writer: crate::W<GPIO_PAD_CONFIG_0_SPEC>) -> Self {
        W(writer)
    }
}
...
#[repr(u8)]
pub enum CONFMODE_A {
    #[doc = "0: General-Purpose I/O"]
    GPIO0 = 0,
    #[doc = "3: UART0 Request To Send O (Active Low)"]
    UART0_RTS = 3,
    #[doc = "4: I2S Audio Port Data 0 (RX/TX)"]
    MCAXR0 = 4,
    #[doc = "6: I2S Audio Port Data 1 (RX/TX)"]
    MCAXR1 = 6,
    #[doc = "7: Timer Capture Port"]
    GT_CCP00 = 7,
    #[doc = "9: General SPI Chip Select"]
    GSPI_CS = 9,
    #[doc = "10: UART1 Request To Send O (Active Low)"]
    UART1_RTS = 10,
    #[doc = "12: UART0 Clear To Send Input (Active Low)"]
    UART0_CTS = 12,
}
...
impl CONFMODE_R {
    ...
    pub fn variant(&self) -> Option<CONFMODE_A> {
        match self.bits {
            0 => Some(CONFMODE_A::GPIO0),
            3 => Some(CONFMODE_A::UART0_RTS),
            4 => Some(CONFMODE_A::MCAXR0),
            6 => Some(CONFMODE_A::MCAXR1),
            7 => Some(CONFMODE_A::GT_CCP00),
            9 => Some(CONFMODE_A::GSPI_CS),
            10 => Some(CONFMODE_A::UART1_RTS),
            12 => Some(CONFMODE_A::UART0_CTS),
            _ => None,
        }
    }
    ...
    pub fn is_gpio0(&self) -> bool {
        **self == CONFMODE_A::GPIO0
    }
    #[doc = "Checks if the value of the field is `UART0_RTS`"]
    #[inline(always)]
    pub fn is_uart0_rts(&self) -> bool {
        **self == CONFMODE_A::UART0_RTS
    }
    #[doc = "Checks if the value of the field is `MCAXR0`"]
    #[inline(always)]
    pub fn is_mc_axr0(&self) -> bool {
        **self == CONFMODE_A::MCAXR0
    }
    #[doc = "Checks if the value of the field is `MCAXR1`"]
    #[inline(always)]
    pub fn is_mc_axr1(&self) -> bool {
        **self == CONFMODE_A::MCAXR1
    }
    #[doc = "Checks if the value of the field is `GT_CCP00`"]
    #[inline(always)]
    pub fn is_gt_ccp00(&self) -> bool {
        **self == CONFMODE_A::GT_CCP00
    }
    #[doc = "Checks if the value of the field is `GSPI_CS`"]
    #[inline(always)]
    pub fn is_gspi_cs(&self) -> bool {
        **self == CONFMODE_A::GSPI_CS
    }
    #[doc = "Checks if the value of the field is `UART1_RTS`"]
    #[inline(always)]
    pub fn is_uart1_rts(&self) -> bool {
        **self == CONFMODE_A::UART1_RTS
    }
    #[doc = "Checks if the value of the field is `UART0_CTS`"]
    #[inline(always)]
    pub fn is_uart0_cts(&self) -> bool {
        **self == CONFMODE_A::UART0_CTS
    }
}
...
impl<'a> CONFMODE_W<'a> {
    ...
    pub fn gpio0(self) -> &'a mut W {
        self.variant(CONFMODE_A::GPIO0)
    }
    #[doc = "UART0 Request To Send O (Active Low)"]
    #[inline(always)]
    pub fn uart0_rts(self) -> &'a mut W {
        self.variant(CONFMODE_A::UART0_RTS)
    }
    #[doc = "I2S Audio Port Data 0 (RX/TX)"]
    #[inline(always)]
    pub fn mc_axr0(self) -> &'a mut W {
        self.variant(CONFMODE_A::MCAXR0)
    }
    #[doc = "I2S Audio Port Data 1 (RX/TX)"]
    #[inline(always)]
    pub fn mc_axr1(self) -> &'a mut W {
        self.variant(CONFMODE_A::MCAXR1)
    }
    #[doc = "Timer Capture Port"]
    #[inline(always)]
    pub fn gt_ccp00(self) -> &'a mut W {
        self.variant(CONFMODE_A::GT_CCP00)
    }
    #[doc = "General SPI Chip Select"]
    #[inline(always)]
    pub fn gspi_cs(self) -> &'a mut W {
        self.variant(CONFMODE_A::GSPI_CS)
    }
    #[doc = "UART1 Request To Send O (Active Low)"]
    #[inline(always)]
    pub fn uart1_rts(self) -> &'a mut W {
        self.variant(CONFMODE_A::UART1_RTS)
    }
    #[doc = "UART0 Clear To Send Input (Active Low)"]
    #[inline(always)]
    pub fn uart0_cts(self) -> &'a mut W {
        self.variant(CONFMODE_A::UART0_CTS)
    }
...
#[doc = "GPIO0 / (ANA) (Pin 50) Pad Config\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [gpio_pad_config_0](index.html) module"]
pub struct GPIO_PAD_CONFIG_0_SPEC;
impl crate::RegisterSpec for GPIO_PAD_CONFIG_0_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [gpio_pad_config_0::R](R) reader structure"]
impl crate::Readable for GPIO_PAD_CONFIG_0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [gpio_pad_config_0::W](W) writer structure"]
impl crate::Writable for GPIO_PAD_CONFIG_0_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets GPIO_PAD_CONFIG_0 to value 0x0c61"]
impl crate::Resettable for GPIO_PAD_CONFIG_0_SPEC {
    #[inline(always)]
