#[doc = "Register `GPIO_PAD_CONFIG_12` reader"]
pub struct R(crate::R<GPIO_PAD_CONFIG_12_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPIO_PAD_CONFIG_12_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<GPIO_PAD_CONFIG_12_SPEC>> for R {
    fn from(reader: crate::R<GPIO_PAD_CONFIG_12_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `GPIO_PAD_CONFIG_12` writer"]
pub struct W(crate::W<GPIO_PAD_CONFIG_12_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GPIO_PAD_CONFIG_12_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<GPIO_PAD_CONFIG_12_SPEC>> for W {
    fn from(writer: crate::W<GPIO_PAD_CONFIG_12_SPEC>) -> Self {
        W(writer)
    }
}
...
pub enum CONFMODE_A {
    ...
    GPIO12 = 0,
    #[doc = "3: I2S Audio Port Clock O"]
    MCACLK = 3,
    #[doc = "4: Parallel Camera Vertical Sync"]
    VSYNC = 4,
    #[doc = "5: I2C Clock"]
    I2C_SCL = 5,
    #[doc = "7: UART0 TX Data"]
...
impl CONFMODE_R {
    ...
    pub fn variant(&self) -> Option<CONFMODE_A> {
        match self.bits {
            0 => Some(CONFMODE_A::GPIO12),
            3 => Some(CONFMODE_A::MCACLK),
            4 => Some(CONFMODE_A::VSYNC),
            5 => Some(CONFMODE_A::I2C_SCL),
            7 => Some(CONFMODE_A::UART0_TX),
            12 => Some(CONFMODE_A::GT_CCP03),
            _ => None,
        }
    }
    ...
    #[doc = "Checks if the value of the field is `GT_CCP03`"]
    #[inline(always)]
    pub fn is_gt_ccp03(&self) -> bool {
        **self == CONFMODE_A::GT_CCP03
    }
}
...
impl<'a> CONFMODE_W<'a> {
    ...
    pub fn gpio12(self) -> &'a mut W {
        self.variant(CONFMODE_A::GPIO12)
    }
    ...
    #[doc = "Parallel Camera Vertical Sync"]
    #[inline(always)]
    pub fn vsync(self) -> &'a mut W {
        self.variant(CONFMODE_A::VSYNC)
    }
    #[doc = "I2C Clock"]
    #[inline(always)]
    ...
    #[inline(always)]
    pub fn gt_ccp03(self) -> &'a mut W {
        self.variant(CONFMODE_A::GT_CCP03)
    }
...
#[doc = "GPIO12 (Pin 3) Pad Config\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [gpio_pad_config_12](index.html) module"]
pub struct GPIO_PAD_CONFIG_12_SPEC;
impl crate::RegisterSpec for GPIO_PAD_CONFIG_12_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [gpio_pad_config_12::R](R) reader structure"]
impl crate::Readable for GPIO_PAD_CONFIG_12_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [gpio_pad_config_12::W](W) writer structure"]
impl crate::Writable for GPIO_PAD_CONFIG_12_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets GPIO_PAD_CONFIG_12 to value 0x0c61"]
impl crate::Resettable for GPIO_PAD_CONFIG_12_SPEC {
    #[inline(always)]
