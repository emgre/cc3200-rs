#[doc = "Register `GPIO_PAD_CONFIG_30` reader"]
pub struct R(crate::R<GPIO_PAD_CONFIG_30_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPIO_PAD_CONFIG_30_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<GPIO_PAD_CONFIG_30_SPEC>> for R {
    fn from(reader: crate::R<GPIO_PAD_CONFIG_30_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `GPIO_PAD_CONFIG_30` writer"]
pub struct W(crate::W<GPIO_PAD_CONFIG_30_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GPIO_PAD_CONFIG_30_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<GPIO_PAD_CONFIG_30_SPEC>> for W {
    fn from(writer: crate::W<GPIO_PAD_CONFIG_30_SPEC>) -> Self {
        W(writer)
    }
}
...
pub enum CONFMODE_A {
    ...
    MCACLK = 2,
    #[doc = "3: I2S Audio Port Frame Sync"]
    MCAFSX = 3,
    #[doc = "4: Timer Capture Port"]
    GT_CCP05 = 4,
    #[doc = "7: General SPI MISO"]
    GSPI_MISO = 7,
    #[doc = "9: UART0 TX Data"]
    UART0_TX = 9,
}
...
impl CONFMODE_R {
    ...
    pub fn variant(&self) -> Option<CONFMODE_A> {
        match self.bits {
            0 => Some(CONFMODE_A::GPIO30),
            2 => Some(CONFMODE_A::MCACLK),
            3 => Some(CONFMODE_A::MCAFSX),
            4 => Some(CONFMODE_A::GT_CCP05),
            7 => Some(CONFMODE_A::GSPI_MISO),
            9 => Some(CONFMODE_A::UART0_TX),
            _ => None,
        }
    }
    ...
    #[doc = "Checks if the value of the field is `GT_CCP05`"]
    #[inline(always)]
    pub fn is_gt_ccp05(&self) -> bool {
        **self == CONFMODE_A::GT_CCP05
    }
    #[doc = "Checks if the value of the field is `GSPI_MISO`"]
    #[inline(always)]
    pub fn is_gspi_miso(&self) -> bool {
        **self == CONFMODE_A::GSPI_MISO
    }
    #[doc = "Checks if the value of the field is `UART0_TX`"]
    #[inline(always)]
    pub fn is_uart0_tx(&self) -> bool {
        **self == CONFMODE_A::UART0_TX
    }
}
...
impl<'a> CONFMODE_W<'a> {
    ...
    pub fn gpio30(self) -> &'a mut W {
        self.variant(CONFMODE_A::GPIO30)
    }
    ...
    #[inline(always)]
    pub fn gt_ccp05(self) -> &'a mut W {
        self.variant(CONFMODE_A::GT_CCP05)
    }
    #[doc = "General SPI MISO"]
    #[inline(always)]
    pub fn gspi_miso(self) -> &'a mut W {
        self.variant(CONFMODE_A::GSPI_MISO)
    }
    #[doc = "UART0 TX Data"]
    #[inline(always)]
    pub fn uart0_tx(self) -> &'a mut W {
        self.variant(CONFMODE_A::UART0_TX)
    }
...
#[doc = "GPIO30 (ANA) (Pin 53) Pad Config\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [gpio_pad_config_30](index.html) module"]
pub struct GPIO_PAD_CONFIG_30_SPEC;
impl crate::RegisterSpec for GPIO_PAD_CONFIG_30_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [gpio_pad_config_30::R](R) reader structure"]
impl crate::Readable for GPIO_PAD_CONFIG_30_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [gpio_pad_config_30::W](W) writer structure"]
impl crate::Writable for GPIO_PAD_CONFIG_30_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets GPIO_PAD_CONFIG_30 to value 0x0c61"]
impl crate::Resettable for GPIO_PAD_CONFIG_30_SPEC {
    #[inline(always)]
