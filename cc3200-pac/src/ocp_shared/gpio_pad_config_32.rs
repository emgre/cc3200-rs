#[doc = "Register `GPIO_PAD_CONFIG_32` reader"]
pub struct R(crate::R<GPIO_PAD_CONFIG_32_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPIO_PAD_CONFIG_32_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<GPIO_PAD_CONFIG_32_SPEC>> for R {
    fn from(reader: crate::R<GPIO_PAD_CONFIG_32_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `GPIO_PAD_CONFIG_32` writer"]
pub struct W(crate::W<GPIO_PAD_CONFIG_32_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GPIO_PAD_CONFIG_32_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<GPIO_PAD_CONFIG_32_SPEC>> for W {
    fn from(writer: crate::W<GPIO_PAD_CONFIG_32_SPEC>) -> Self {
        W(writer)
    }
}
...
pub enum CONFMODE_A {
    ...
    GPIO32 = 0,
    #[doc = "1: Connect 32.768kHz XTAL or connect a 100kΩ to Vsupply"]
    RTC_XTAL_N = 1,
    #[doc = "2: I2S Audio Port Clock O"]
    MCACLK = 2,
    #[doc = "4: I2S Audio Port Data (Only O Mode Supported On Pin 52)"]
    MCAXR0 = 4,
    #[doc = "6: UART0 Request To Send O (Active Low)"]
    UART0_RTS = 6,
    #[doc = "8: General SPI MOSI"]
    GSPI_MOSI = 8,
}
...
impl CONFMODE_R {
    ...
    pub fn variant(&self) -> Option<CONFMODE_A> {
        match self.bits {
            0 => Some(CONFMODE_A::GPIO32),
            1 => Some(CONFMODE_A::RTC_XTAL_N),
            2 => Some(CONFMODE_A::MCACLK),
            4 => Some(CONFMODE_A::MCAXR0),
            6 => Some(CONFMODE_A::UART0_RTS),
            8 => Some(CONFMODE_A::GSPI_MOSI),
            _ => None,
        }
    }
    ...
    pub fn is_gpio32(&self) -> bool {
        **self == CONFMODE_A::GPIO32
    }
    #[doc = "Checks if the value of the field is `RTC_XTAL_N`"]
    #[inline(always)]
    pub fn is_rtc_xtal_n(&self) -> bool {
        **self == CONFMODE_A::RTC_XTAL_N
    }
    #[doc = "Checks if the value of the field is `MCACLK`"]
    #[inline(always)]
    pub fn is_mc_aclk(&self) -> bool {
        **self == CONFMODE_A::MCACLK
    }
    ...
    #[doc = "Checks if the value of the field is `GSPI_MOSI`"]
    #[inline(always)]
    pub fn is_gspi_mosi(&self) -> bool {
        **self == CONFMODE_A::GSPI_MOSI
    }
}
...
impl<'a> CONFMODE_W<'a> {
    ...
    pub fn gpio32(self) -> &'a mut W {
        self.variant(CONFMODE_A::GPIO32)
    }
    #[doc = "Connect 32.768kHz XTAL or connect a 100kΩ to Vsupply"]
    #[inline(always)]
    pub fn rtc_xtal_n(self) -> &'a mut W {
        self.variant(CONFMODE_A::RTC_XTAL_N)
    }
    #[doc = "I2S Audio Port Clock O"]
    #[inline(always)]
    pub fn mc_aclk(self) -> &'a mut W {
        self.variant(CONFMODE_A::MCACLK)
    }
    #[doc = "I2S Audio Port Data (Only O Mode Supported On Pin 52)"]
    #[inline(always)]
    ...
    #[doc = "General SPI MOSI"]
    #[inline(always)]
    pub fn gspi_mosi(self) -> &'a mut W {
        self.variant(CONFMODE_A::GSPI_MOSI)
    }
...
#[doc = "GPIO32 (RTC_XTAL_N) (Pin 52) Pad Config\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [gpio_pad_config_32](index.html) module"]
pub struct GPIO_PAD_CONFIG_32_SPEC;
impl crate::RegisterSpec for GPIO_PAD_CONFIG_32_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [gpio_pad_config_32::R](R) reader structure"]
impl crate::Readable for GPIO_PAD_CONFIG_32_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [gpio_pad_config_32::W](W) writer structure"]
impl crate::Writable for GPIO_PAD_CONFIG_32_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets GPIO_PAD_CONFIG_32 to value 0x0c61"]
impl crate::Resettable for GPIO_PAD_CONFIG_32_SPEC {
    #[inline(always)]
