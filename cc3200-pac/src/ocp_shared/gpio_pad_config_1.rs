#[doc = "Register `GPIO_PAD_CONFIG_1` reader"]
pub struct R(crate::R<GPIO_PAD_CONFIG_1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPIO_PAD_CONFIG_1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<GPIO_PAD_CONFIG_1_SPEC>> for R {
    fn from(reader: crate::R<GPIO_PAD_CONFIG_1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `GPIO_PAD_CONFIG_1` writer"]
pub struct W(crate::W<GPIO_PAD_CONFIG_1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GPIO_PAD_CONFIG_1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<GPIO_PAD_CONFIG_1_SPEC>> for W {
    fn from(writer: crate::W<GPIO_PAD_CONFIG_1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub enum CONFMODE_A {
    ...
    #[doc = "3: UART0 TX Data"]
    UART0_TX = 3,
    #[doc = "4: Pixel Clock from Parallel Camera Sensor"]
    PIXCLK = 4,
    #[doc = "6: UART1 TX Data"]
    UART1_TX = 6,
...
impl CONFMODE_R {
    ...
    pub fn variant(&self) -> Option<CONFMODE_A> {
        match self.bits {
            0 => Some(CONFMODE_A::GPIO1),
            3 => Some(CONFMODE_A::UART0_TX),
            4 => Some(CONFMODE_A::PIXCLK),
            6 => Some(CONFMODE_A::UART1_TX),
            7 => Some(CONFMODE_A::GT_CCP01),
            _ => None,
        }
    }
    ...
    #[doc = "Checks if the value of the field is `PIXCLK`"]
    #[inline(always)]
    pub fn is_pixclk(&self) -> bool {
        **self == CONFMODE_A::PIXCLK
    }
...
impl<'a> CONFMODE_W<'a> {
    ...
    #[doc = "Pixel Clock from Parallel Camera Sensor"]
    #[inline(always)]
    pub fn pixclk(self) -> &'a mut W {
        self.variant(CONFMODE_A::PIXCLK)
    }
    #[doc = "UART1 TX Data"]
    #[inline(always)]
...
#[doc = "GPIO1 (Pin 55) Pad Config\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [gpio_pad_config_1](index.html) module"]
pub struct GPIO_PAD_CONFIG_1_SPEC;
impl crate::RegisterSpec for GPIO_PAD_CONFIG_1_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [gpio_pad_config_1::R](R) reader structure"]
impl crate::Readable for GPIO_PAD_CONFIG_1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [gpio_pad_config_1::W](W) writer structure"]
impl crate::Writable for GPIO_PAD_CONFIG_1_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets GPIO_PAD_CONFIG_1 to value 0x0c61"]
impl crate::Resettable for GPIO_PAD_CONFIG_1_SPEC {
    #[inline(always)]
