#[doc = "Register `GPIO_PAD_CONFIG_11` reader"]
pub struct R(crate::R<GPIO_PAD_CONFIG_11_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPIO_PAD_CONFIG_11_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<GPIO_PAD_CONFIG_11_SPEC>> for R {
    fn from(reader: crate::R<GPIO_PAD_CONFIG_11_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `GPIO_PAD_CONFIG_11` writer"]
pub struct W(crate::W<GPIO_PAD_CONFIG_11_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GPIO_PAD_CONFIG_11_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<GPIO_PAD_CONFIG_11_SPEC>> for W {
    fn from(writer: crate::W<GPIO_PAD_CONFIG_11_SPEC>) -> Self {
        W(writer)
    }
}
...
pub enum CONFMODE_A {
    ...
    #[doc = "1: I2C Data"]
    I2C_SDA = 1,
    #[doc = "3: Pulse-Width Modulated O/P"]
    GT_PWM07 = 3,
    #[doc = "4: Free Clock To Parallel Camera"]
    XVCLK = 4,
    #[doc = "6: SD Card Command Line"]
    SDCARD_CMD = 6,
    #[doc = "7: UART1 RX Data"]
    UART1_RX = 7,
    #[doc = "12: Timer Capture Port"]
    GT_CCP02 = 12,
    #[doc = "13: I2S Audio Port Frame Sync"]
    MCAFSX = 13,
}
...
impl CONFMODE_R {
    ...
    pub fn variant(&self) -> Option<CONFMODE_A> {
        match self.bits {
            0 => Some(CONFMODE_A::GPIO11),
            1 => Some(CONFMODE_A::I2C_SDA),
            3 => Some(CONFMODE_A::GT_PWM07),
            4 => Some(CONFMODE_A::XVCLK),
            6 => Some(CONFMODE_A::SDCARD_CMD),
            7 => Some(CONFMODE_A::UART1_RX),
            12 => Some(CONFMODE_A::GT_CCP02),
            13 => Some(CONFMODE_A::MCAFSX),
            _ => None,
        }
    }
    ...
    pub fn is_gpio11(&self) -> bool {
        **self == CONFMODE_A::GPIO11
    }
    #[doc = "Checks if the value of the field is `I2C_SDA`"]
    #[inline(always)]
    pub fn is_i2c_sda(&self) -> bool {
        **self == CONFMODE_A::I2C_SDA
    }
    #[doc = "Checks if the value of the field is `GT_PWM07`"]
    #[inline(always)]
    pub fn is_gt_pwm07(&self) -> bool {
        **self == CONFMODE_A::GT_PWM07
    }
    #[doc = "Checks if the value of the field is `XVCLK`"]
    #[inline(always)]
    pub fn is_xvclk(&self) -> bool {
        **self == CONFMODE_A::XVCLK
    }
    #[doc = "Checks if the value of the field is `SDCARD_CMD`"]
    #[inline(always)]
    pub fn is_sdcard_cmd(&self) -> bool {
        **self == CONFMODE_A::SDCARD_CMD
    }
    #[doc = "Checks if the value of the field is `UART1_RX`"]
    #[inline(always)]
    pub fn is_uart1_rx(&self) -> bool {
        **self == CONFMODE_A::UART1_RX
    }
    #[doc = "Checks if the value of the field is `GT_CCP02`"]
    #[inline(always)]
    pub fn is_gt_ccp02(&self) -> bool {
        **self == CONFMODE_A::GT_CCP02
    }
    #[doc = "Checks if the value of the field is `MCAFSX`"]
    #[inline(always)]
    pub fn is_mc_afsx(&self) -> bool {
        **self == CONFMODE_A::MCAFSX
    }
}
...
impl<'a> CONFMODE_W<'a> {
    ...
    pub fn gpio11(self) -> &'a mut W {
        self.variant(CONFMODE_A::GPIO11)
    }
    #[doc = "I2C Data"]
    #[inline(always)]
    pub fn i2c_sda(self) -> &'a mut W {
        self.variant(CONFMODE_A::I2C_SDA)
    }
    #[doc = "Pulse-Width Modulated O/P"]
    #[inline(always)]
    pub fn gt_pwm07(self) -> &'a mut W {
        self.variant(CONFMODE_A::GT_PWM07)
    }
    #[doc = "Free Clock To Parallel Camera"]
    #[inline(always)]
    pub fn xvclk(self) -> &'a mut W {
        self.variant(CONFMODE_A::XVCLK)
    }
    #[doc = "SD Card Command Line"]
    #[inline(always)]
    pub fn sdcard_cmd(self) -> &'a mut W {
        self.variant(CONFMODE_A::SDCARD_CMD)
    }
    #[doc = "UART1 RX Data"]
    #[inline(always)]
    pub fn uart1_rx(self) -> &'a mut W {
        self.variant(CONFMODE_A::UART1_RX)
    }
    #[doc = "Timer Capture Port"]
    #[inline(always)]
    pub fn gt_ccp02(self) -> &'a mut W {
        self.variant(CONFMODE_A::GT_CCP02)
    }
    #[doc = "I2S Audio Port Frame Sync"]
    #[inline(always)]
    pub fn mc_afsx(self) -> &'a mut W {
        self.variant(CONFMODE_A::MCAFSX)
    }
...
#[doc = "GPIO11 (Pin 2) Pad Config\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [gpio_pad_config_11](index.html) module"]
pub struct GPIO_PAD_CONFIG_11_SPEC;
impl crate::RegisterSpec for GPIO_PAD_CONFIG_11_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [gpio_pad_config_11::R](R) reader structure"]
impl crate::Readable for GPIO_PAD_CONFIG_11_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [gpio_pad_config_11::W](W) writer structure"]
impl crate::Writable for GPIO_PAD_CONFIG_11_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets GPIO_PAD_CONFIG_11 to value 0x0c61"]
impl crate::Resettable for GPIO_PAD_CONFIG_11_SPEC {
    #[inline(always)]
