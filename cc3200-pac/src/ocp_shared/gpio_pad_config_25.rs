#[doc = "Register `GPIO_PAD_CONFIG_25` reader"]
pub struct R(crate::R<GPIO_PAD_CONFIG_25_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPIO_PAD_CONFIG_25_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<GPIO_PAD_CONFIG_25_SPEC>> for R {
    fn from(reader: crate::R<GPIO_PAD_CONFIG_25_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `GPIO_PAD_CONFIG_25` writer"]
pub struct W(crate::W<GPIO_PAD_CONFIG_25_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GPIO_PAD_CONFIG_25_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<GPIO_PAD_CONFIG_25_SPEC>> for W {
    fn from(writer: crate::W<GPIO_PAD_CONFIG_25_SPEC>) -> Self {
        W(writer)
    }
}
...
pub enum CONFMODE_A {
    ...
    GPIO25 = 0,
    #[doc = "2: I2S Audio Port Frame Sync"]
    MCAFSX = 2,
    #[doc = "9: Pulse-Width Modulated O/P"]
    GT_PWM02 = 9,
}
...
impl CONFMODE_R {
    ...
    pub fn variant(&self) -> Option<CONFMODE_A> {
        match self.bits {
            0 => Some(CONFMODE_A::GPIO25),
            2 => Some(CONFMODE_A::MCAFSX),
            9 => Some(CONFMODE_A::GT_PWM02),
            _ => None,
        }
    }
    ...
    #[doc = "Checks if the value of the field is `GT_PWM02`"]
    #[inline(always)]
    pub fn is_gt_pwm02(&self) -> bool {
        **self == CONFMODE_A::GT_PWM02
    }
}
...
impl<'a> CONFMODE_W<'a> {
    ...
    pub fn gpio25(self) -> &'a mut W {
        self.variant(CONFMODE_A::GPIO25)
    }
    ...
    #[inline(always)]
    pub fn gt_pwm02(self) -> &'a mut W {
        self.variant(CONFMODE_A::GT_PWM02)
    }
...
#[doc = "GPIO25 (SOP2) (Pin 21) Pad Config\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [gpio_pad_config_25](index.html) module"]
pub struct GPIO_PAD_CONFIG_25_SPEC;
impl crate::RegisterSpec for GPIO_PAD_CONFIG_25_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [gpio_pad_config_25::R](R) reader structure"]
impl crate::Readable for GPIO_PAD_CONFIG_25_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [gpio_pad_config_25::W](W) writer structure"]
impl crate::Writable for GPIO_PAD_CONFIG_25_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets GPIO_PAD_CONFIG_25 to value 0x0c61"]
impl crate::Resettable for GPIO_PAD_CONFIG_25_SPEC {
    #[inline(always)]
